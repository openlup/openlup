...
describe("/api/bff/customers/orders route", () => {
  ...
  it("executes the order-detail route and fails closed before clients when disabled", async () => {
    const { default: handler } = await import("./orders/detail.js");
    const res = createResponse();
