...
describe("GET /api/bff/customers/payment-methods route", () => {
  ...
  it("fails closed before creating Supabase clients when customer self-service flags are off", async () => {
    const { default: handler } = await import("./payment-methods.js");
  ...
  it("returns an internal error envelope when enabled without Supabase service env", async () => {
