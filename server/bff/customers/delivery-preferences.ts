...
import { createCustomerDeliveryPreferencesHandler } from "../../domains/customers/customerDeliveryPreferencesHandler.js";
import { createSupabaseCustomerDeliveryPreferencesPort } from "../../adapters/supabase/customerPreferencePorts.js";
import {
...
async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createCustomerDeliveryPreferencesHandler({
    preferencesPort: createSupabaseCustomerDeliveryPreferencesPort(client),
...
export default withObservedRoute({
  route: "/api/bff/customers/delivery-preferences",
  domain: "customers",
  surface: "customer",
  risk: "mutation",
