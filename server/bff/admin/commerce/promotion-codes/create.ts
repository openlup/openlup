...
import { createAdminPromotionCodeCreateHandler } from "../../../../domains/commerce/adminPromotionCodesHandler.js";
import {
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminPromotionCodeCreateHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/commerce/promotion-codes/create",
