...
import { createAdminPromotionCodesListHandler } from "../../../../domains/commerce/adminPromotionCodesHandler.js";
import {
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  const context = composeAdminPromotionCodes(req, res);
  if (!context) return Promise.resolve();
  return createAdminPromotionCodesListHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/commerce/promotion-codes/list",
