...
import { createApplyHiddenCheckoutPaymentResultHandler } from "../../../../domains/commerce/commerceRuntimeHandlers.js";
import {
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createApplyHiddenCheckoutPaymentResultHandler({
    runtimePort,
...
export default withObservedRoute({
  route: "/api/bff/admin/commerce/runtime/payment-result",
  domain: "commerce",
  surface: "admin",
  risk: "mutation",
}, handler);
