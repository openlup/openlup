...
import { createAdminCatalogGetHandler } from "../../../../domains/commerce/adminCatalogReadHandler.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCatalogGetHandler({
...
export default withObservedRoute(
  {
    route: "/api/bff/admin/commerce/catalog/get",
    domain: "commerce",
    surface: "admin",
    risk: "read",
  },
