...
import { createAdminCatalogRestoreHandler } from "../../../../domains/commerce/adminCatalogHandler.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCatalogRestoreHandler({
...
export default withObservedRoute(
  {
    route: "/api/bff/admin/commerce/catalog/restore",
    domain: "commerce",
    surface: "admin",
    risk: "mutation",
  },
