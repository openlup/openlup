...
import { createAdminCatalogCloneDraftHandler } from "../../../../domains/commerce/adminCatalogHandler.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCatalogCloneDraftHandler({
...
export default withObservedRoute(
  {
    route: "/api/bff/admin/commerce/catalog/clone-draft",
    domain: "commerce",
    surface: "admin",
    risk: "mutation",
  },
