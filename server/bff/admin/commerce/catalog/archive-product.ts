...
import { createAdminCatalogArchiveProductHandler } from "../../../../domains/commerce/adminCatalogHandler.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCatalogArchiveProductHandler({
...
export default withObservedRoute(
  {
    route: "/api/bff/admin/commerce/catalog/archive-product",
    domain: "commerce",
    surface: "admin",
    risk: "mutation",
  },
