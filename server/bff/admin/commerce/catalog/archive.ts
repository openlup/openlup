...
import { createAdminCatalogArchiveHandler } from "../../../../domains/commerce/adminCatalogHandler.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCatalogArchiveHandler({
...
export default withObservedRoute(
  {
    route: "/api/bff/admin/commerce/catalog/archive",
    domain: "commerce",
    surface: "admin",
    risk: "mutation",
  },
