...
import { createAdminCatalogHistoryHandler } from "../../../../domains/commerce/adminCatalogReadHandler.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCatalogHistoryHandler({
...
export default withObservedRoute(
  {
    route: "/api/bff/admin/commerce/catalog/history",
    domain: "commerce",
    surface: "admin",
    risk: "read",
  },
