...
import { createAdminCatalogSetPriceHandler } from "../../../../domains/commerce/adminCatalogHandler.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCatalogSetPriceHandler({
...
export default withObservedRoute(
  {
    route: "/api/bff/admin/commerce/catalog/set-price",
    domain: "commerce",
    surface: "admin",
    risk: "mutation",
  },
