...
import { createAdminCommerceFulfillmentCreateOrderHandler } from "../../../../domains/fulfillment/commerceFulfillmentHandlers.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCommerceFulfillmentCreateOrderHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/fulfillment/commerce-orders/create",
  domain: "fulfillment",
  surface: "admin",
  risk: "mutation",
}, handler);
