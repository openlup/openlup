...
import { createAdminCommerceFulfillmentTrackingEventHandler } from "../../../../domains/fulfillment/commerceFulfillmentHandlers.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCommerceFulfillmentTrackingEventHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/fulfillment/commerce-orders/record-tracking-event",
  domain: "fulfillment",
  surface: "admin",
  risk: "mutation",
}, handler);
