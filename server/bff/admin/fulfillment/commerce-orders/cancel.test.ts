...
import routeHandler from "./cancel.js";
...
describe("admin fulfillment cancel route boundary", () => {
  it("uses the fulfillment gateway instead of direct service-role port construction", () => {
    const source = read("server/bff/admin/fulfillment/commerce-orders/cancel.ts");
