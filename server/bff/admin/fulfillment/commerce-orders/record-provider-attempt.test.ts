...
import routeHandler from "./record-provider-attempt.js";
...
describe("admin fulfillment record provider attempt route boundary", () => {
  it("uses the fulfillment gateway instead of direct service-role port construction", () => {
    const source = read("server/bff/admin/fulfillment/commerce-orders/record-provider-attempt.ts");
