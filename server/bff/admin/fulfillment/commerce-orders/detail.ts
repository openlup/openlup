...
import { createAdminCommerceFulfillmentOrderDetailHandler } from "../../../../domains/fulfillment/commerceFulfillmentHandlers.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCommerceFulfillmentOrderDetailHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/fulfillment/commerce-orders/detail",
  domain: "fulfillment",
  surface: "admin",
  risk: "mutation",
}, handler);
