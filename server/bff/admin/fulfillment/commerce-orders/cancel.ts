...
import { createAdminCommerceFulfillmentCancelOrderHandler } from "../../../../domains/fulfillment/commerceFulfillmentHandlers.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCommerceFulfillmentCancelOrderHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/fulfillment/commerce-orders/cancel",
  domain: "fulfillment",
  surface: "admin",
  risk: "mutation",
}, handler);
