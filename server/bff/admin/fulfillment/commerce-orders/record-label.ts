...
import { createAdminCommerceFulfillmentRecordLabelHandler } from "../../../../domains/fulfillment/commerceFulfillmentHandlers.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCommerceFulfillmentRecordLabelHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/fulfillment/commerce-orders/record-label",
  domain: "fulfillment",
  surface: "admin",
  risk: "mutation",
}, handler);
