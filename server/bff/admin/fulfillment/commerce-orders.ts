...
import { createAdminCommerceFulfillmentOrdersListHandler } from "../../../domains/fulfillment/commerceFulfillmentHandlers.js";
...
} from "./commerce-orders/shared.js";
...
function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createAdminCommerceFulfillmentOrdersListHandler({
    fulfillmentPort: gateway.readPort,
    authorizeAdmin: () => authorizeCommerceFulfillmentAdminWithUser(authClient, accessToken),
  })(req, res);
}

export default withObservedRoute({
  route: "/api/bff/admin/fulfillment/commerce-orders",
  domain: "fulfillment",
  surface: "admin",
  risk: "mutation",
}, handler);
