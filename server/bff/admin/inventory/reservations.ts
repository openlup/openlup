...
import { createAdminInventoryReservationsHandler } from "../../../domains/inventory/inventoryHandlers.js";
import {
...
export function createAdminInventoryReservationsRouteHandler(
  ...
  return function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
    ...
    return createAdminInventoryReservationsHandler({
...
const handler = createAdminInventoryReservationsRouteHandler();

export default withObservedRoute({
  route: "/api/bff/admin/inventory/reservations",
  domain: "inventory",
  surface: "admin",
  risk: "mutation",
}, handler);
