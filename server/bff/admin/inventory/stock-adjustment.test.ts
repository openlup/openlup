...
describe("inventory stock-adjustment BFF boundary", () => {
  it("mutates inventory through the domain gateway", () => {
    const source = readFileSync(
      join(process.cwd(), "server/bff/admin/inventory/stock-adjustment.ts"),
      "utf8",
    );
