...
import { createAdminInventoryStockHandler } from "../../../domains/inventory/inventoryHandlers.js";
import {
...
export function createAdminInventoryStockRouteHandler(
  ...
  return function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
    ...
    return createAdminInventoryStockHandler({
...
const handler = createAdminInventoryStockRouteHandler();

export default withObservedRoute({
  route: "/api/bff/admin/inventory/stock",
  domain: "inventory",
  surface: "admin",
  risk: "mutation",
}, handler);
