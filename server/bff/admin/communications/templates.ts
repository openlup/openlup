...
import { createCommunicationsAdminTemplatesReadHandler } from "../../../domains/communications/adminTemplatesHandler.js";
...
async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  return createCommunicationsAdminTemplatesReadHandler({
    readPort: createSupabaseCommunicationsActorGateway(client).templatesPort(),
...
export default withObservedRoute({
  route: "/api/bff/admin/communications/templates",
