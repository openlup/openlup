...
import { createCommunicationsAdminTemplateActiveHandler } from "../../../../domains/communications/adminTemplatesHandler.js";
...
export default withObservedRoute({
  route: "/api/bff/admin/communications/templates/active",
