...
import { createPaymentSettlementRecordHandler } from "../../../domains/accounting/accountingHandlers.js";
...
async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  const route = createPaymentSettlementRecordHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/accounting/settlements",
  domain: "accounting",
  surface: "admin",
  risk: "mutation",
