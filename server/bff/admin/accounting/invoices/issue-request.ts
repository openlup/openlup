...
import { createAccountingInvoiceIssueHandler } from "../../../../domains/accounting/accountingHandlers.js";
...
async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  const route = createAccountingInvoiceIssueHandler({
...
export default withObservedRoute({
  route: "/api/bff/admin/accounting/invoices/issue-request",
  domain: "accounting",
  surface: "admin",
  risk: "mutation",
