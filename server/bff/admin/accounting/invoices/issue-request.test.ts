...
import handler from "./issue-request.js";

describe("accounting invoice issue-request BFF boundary", () => {
  it("builds accounting persistence through the domain gateway", () => {
    const source = readFileSync(
      join(process.cwd(), "server/bff/admin/accounting/invoices/issue-request.ts"),
      "utf8",
    );
