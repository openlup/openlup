import type { EngineSubscription, SubscriptionEngineResult } from "./subscriptionEngine.js";
...
export const baseTemplate: SubscriptionTemplateSnapshot = {
  ...
  currency: "PLN",
  region_code: "PL",
  // E9: subject_ref is canonical; the legacy field stays populated as a deprecated alias.
